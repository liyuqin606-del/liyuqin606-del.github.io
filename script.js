...
(() => {
  ...
  const chinese = Object.freeze({
    ...
    explore: '了解我的研究',
    figureDescription: '循环计算的概念示意：流动的隐状态轨迹反复经过同一个共享算子，以三维回路上的固定门表示。',
    figureCaption: '研究直觉 · 概念示意',
    figureLoopTitle: '循环计算',
    figureLoopCaption: '共享核心，递归深度',
    figureShared: '共享权重',
    figurePause: '暂停动画',
    figureNav: '选择研究示意图',
    figureSelectLoop: '循环深度',
    figureSelectLatent: '隐空间',
    figureSelectRSI: '自我改进',
    figureLatentDescription: '隐状态轨迹的概念示意：在抽象状态空间曲面上，重复计算对隐表征进行迭代与细化。',
    figureLatentTitle: '隐空间',
    figureLatentSubtitle: '状态的迭代',
    figureLatentCaption: '多轮计算，更新表征',
    figureRSIDescription: 'RSI 概念回路：提出、检验和修订候选方案，反馈也用于修订后续改进所采用的方法。',
    figureRSIPropose: '提出',
    figureRSITest: '检验',
    figureRSIRevise: '修订',
    figureRSIImprover: '改进器',
    figureRSIMethod: '改进改进器本身。',
    figureRSIMethodNote: '让反馈作用于改进方法',
    basedAt: '所在院校',
